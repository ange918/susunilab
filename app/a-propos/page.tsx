...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-grow pt-32 pb-24 dark:bg-[#1B2441] transition-colors duration-300">
        <section className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold text-[#1B2441] dark:text-white mb-8 leading-tight">
            ...
            <motion.div 
              className="relative aspect-square bg-gray-100 dark:bg-white/5 rounded-3xl overflow-hidden shadow-2xl group"
            ...
            >
               ...
               <div className="absolute inset-0 flex items-center justify-center text-[#1B2441]/20 dark:text-white/10 font-bold text-4xl">
                 CREATIVITÉ • VISION
               </div>
            </motion.div>
          </div>
          ...
          <div className="mt-32">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-5xl font-bold text-[#1B2441] dark:text-white mb-4">Notre Équipe</h2>
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">Des passionnés dédiés à l'excellence et à l'innovation.</p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                <motion.div 
                  key={member.name}
                  className="bg-white dark:bg-white/5 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-white/10 group flex flex-col"
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: idx * 0.1 }}
                >
                  <div className="aspect-[3/4] relative overflow-hidden bg-gray-50 dark:bg-[#1B2441]">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
                  ...
                  <div className="p-4 flex-grow flex flex-col justify-center">
                    <h3 className="text-sm font-bold text-[#1B2441] dark:text-white leading-tight mb-1">{member.name}</h3>
          ...
          <div className="mt-32">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-5xl font-bold text-[#1B2441] dark:text-white mb-4">Notre Vision & Engagement</h2>
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">Quatre piliers fondamentaux qui guident chacune de nos actions et définissent notre identité.</p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               <motion.div 
                 className="bg-[#1B2441] dark:bg-white/5 text-white p-8 rounded-2xl flex flex-col h-full transform transition-transform hover:-translate-y-2 border border-transparent dark:border-white/10"
                 initial={{ opacity: 0, y: 30 }}
                 whileInView={{ opacity: 1, y: 0 }}
                 viewport={{ once: true }}
               ...
               <motion.div 
                 className="bg-white dark:bg-[#1B2441] border border-gray-100 dark:border-white/10 shadow-sm p-8 rounded-2xl flex flex-col h-full transform transition-transform hover:-translate-y-2"
                 initial={{ opacity: 0, y: 30 }}
                 whileInView={{ opacity: 1, y: 0 }}
                 viewport={{ once: true }}
                 transition={{ delay: 0.2 }}
               >
                  <div className="w-12 h-12 bg-[#1B2441] dark:bg-[#0078B7] text-white rounded-full flex items-center justify-center mb-6">
                    <span className="text-xl font-bold">02</span>
                  </div>
                  <h3 className="text-2xl font-bold mb-4 text-[#1B2441] dark:text-white">La Mission</h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed flex-grow">Accompagner les acteurs de demain par l'innovation, le conseil et la transmission de savoirs stratégiques à fort impact.</p>
               </motion.div>
               <motion.div 
               ...
               <motion.div 
                 className="bg-gray-100 dark:bg-white/5 p-8 rounded-2xl flex flex-col h-full transform transition-transform hover:-translate-y-2 border border-transparent dark:border-white/10"
                 initial={{ opacity: 0, y: 30 }}
                 whileInView={{ opacity: 1, y: 0 }}
                 viewport={{ once: true }}
               ...
               >
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-[#1B2441] dark:text-white">L'Approche</h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed flex-grow">Une méthodologie hybride alliant rigueur stratégique, intuition créative et une compréhension profonde des contextes locaux.</p>
               </motion.div>
            </div>
          </div>
        </section>
