        ...
        <section className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Fondé au Bénin avec une ambition internationale, **SUSUNI
                  LAB** est né d'une volonté profonde : raconter l'Afrique de
                  demain à travers le prisme de la créativité, de la stratégie
                  et de l'innovation. Nous sommes un laboratoire hybride où les
                  idées prennent vie pour transformer les industries créatives.
                </p>
                <p>
                  Notre vision est celle d'une Afrique audacieuse, capable de
                  définir ses propres standards et de rayonner mondialement par
                  son excellence. Nous croyons que la culture et la technologie
                  sont les deux moteurs essentiels de cette renaissance.
                </p>
                <p>
                  En tant que laboratoire, notre mission est triple :
                  **explorer** les richesses culturelles inexplorées,
                  **accompagner** les marques et talents vers l'excellence
                  stratégique, et **transmettre** les savoirs nécessaires pour
                  structurer l'avenir créatif du continent.
                </p>
                <p>
                  Que nous travaillions localement au Bénin ou avec des
                  partenaires internationaux, notre approche reste la même : une
                  rigueur sans faille, une authenticité radicale et une quête
                  permanente d'impact durable.
                </p>
              </div>
            </motion.div>
            <motion.div
          ...
          <div className="mt-32">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-5xl font-bold text-[#1B2441] mb-4">
                Notre Équipe
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                Des passionnés dédiés à l'excellence et à l'innovation.
              </p>
            </motion.div>
              ...
              {[
                ...
                >
                  ...
                  <div className="p-4 flex-grow flex flex-col justify-center">
                    <h3 className="text-sm font-bold text-[#1B2441] leading-tight mb-1">
                      {member.name}
                    </h3>
                    <p className="text-[#0078B7] text-xs font-medium">
                      {member.role}
                    </p>
                  </div>
                </motion.div>
          ...
          <div className="mt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <p className="opacity-80 leading-relaxed flex-grow">
                  Être le catalyseur de la nouvelle vague créative et
                  intellectuelle africaine, en connectant traditions et
                  futurisme pour un rayonnement mondial.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 text-[#1B2441]">
                  La Mission
                </h3>
                <p className="text-gray-600 leading-relaxed flex-grow">
                  Accompagner les acteurs de demain par l'innovation, le conseil
                  et la transmission de savoirs stratégiques à fort impact.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="opacity-90 leading-relaxed flex-grow">
                  Excellence sans compromis, authenticité radicale, audace
                  créative et impact social durable à travers la culture et
                  l'innovation.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed flex-grow">
                  Une méthodologie hybride alliant rigueur stratégique,
                  intuition créative et une compréhension profonde des contextes
                  locaux.
                </p>
              </motion.div>
            </div>
