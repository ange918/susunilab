...
export default function Home() {
  ...
  const testimonials = [
    {
      quote: "Une approche rafraîchissante et profondément ancrée. SUSUNI LAB a su transformer notre vision en une réalité stratégique impactante.",
      name: "Jean-Paul D.",
      designation: "Directeur Artistique",
      src: "/testimonials/jp.jpg",
    },
    {
      quote: "Leur expertise en ingénierie culturelle est unique sur le continent. Un partenaire indispensable pour nos projets d'innovation.",
      name: "Aminata S.",
      designation: "Fondatrice, Tech-Heritage",
      src: "/testimonials/aminata.jpg",
    },
    {
      quote: "Plus qu'un laboratoire, c'est un véritable écosystème de création et de réflexion pour l'Afrique de demain.",
      name: "Marc K.",
      designation: "Consultant Stratégique",
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main>
        ...
        <section id="propos" className="py-32 bg-white transition-colors duration-300">
        ...
        {/* BRANCHES SECTION */}
        <section id="branches" className="py-32 bg-gray-50 transition-colors duration-300">
        ...
        {/* FAQ SECTION */}
        <section id="faq" className="py-32 bg-white transition-colors duration-300">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-6">
              {[
                ...
                {
                  q: "Est-il possible de rejoindre l'équipe de SUSUNI LAB ?",
                  a: "Nous sommes toujours à la recherche de nouveaux talents. Vous pouvez envoyer votre candidature spontanée via notre formulaire de contact.",
                },
                {
                  q: "Proposez-vous des services de consulting pour les particuliers ?",
                  a: "Oui, notre branche Consulting accompagne aussi bien les entreprises que les porteurs de projets individuels dans leur stratégie de développement.",
                },
                {
        ...
        <section id="temoignages" className="py-32 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-[#1B2441]">
