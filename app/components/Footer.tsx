      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-600">
            <li><Link href="/" className="hover:text-[#0078B7]">Accueil</Link></li>
            <li><Link href="/a-propos" className="hover:text-[#0078B7]">À propos</Link></li>
            <li><Link href="/#branches" className="hover:text-[#0078B7]">Nos branches</Link></li>
            <li><Link href="/#projets" className="hover:text-[#0078B7]">Projets</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-600">
            ...
            <li className="flex items-start">
              ...
              <span>Bénin / Afrique / International</span>
            </li>
          </ul>
        </div>
        <div>
