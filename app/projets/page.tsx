...
const projectCategories = [
  {
    ...
    projects: [
      { title: "Symphonie Urbaine", desc: "Campagne visuelle pour une marque de mode locale.", type: "Visual Arts", status: "En cours" },
      { title: "Identité Renaissance", desc: "Refonte d'image pour un collectif d'artistes.", type: "Branding", status: "En cours" }
    ]
  },
  {
    id: "culturels",
    ...
    projects: [
      { title: "Route des Palais", desc: "Guide numérique interactif du patrimoine royal.", type: "Tourisme", status: "En cours" },
      { title: "Echos d'Ancetres", desc: "Série documentaire sur les rites traditionnels.", type: "Patrimoine", status: "En cours" }
    ]
  },
  {
    id: "formation",
    ...
    projects: [
      { 
        ...
        desc: "Le guide complet pour se préparer, comprendre et affronter le marché du mannequinat.", 
        type: "E-book", 
        status: "Réalisé",
        image: "/ebook/cover.jpg",
        link: "/learning/ebook-mannequin"
      },
      { title: "Fash-Mentors", desc: "Programme de mentorat pour designers émergents.", type: "Mentoring", status: "En cours" }
    ]
  },
  {
    id: "innovation",
            ...
            <div key={cat.id} className="mb-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                {cat.projects.map((project) => (
                  ...
                  >
                    <div className={`aspect-[16/10] rounded-3xl overflow-hidden mb-6 relative ${project.status === "En cours" ? "grayscale opacity-70" : "shadow-xl"}`}>
                      {project.image ? (
                        <Image
                          src={project.image}
                          alt={project.title}
                      ...
                      {project.link && (
                        <Link href={project.link} className="absolute inset-0 bg-[#1B2441]/0 group-hover:bg-[#1B2441]/40 transition-all duration-500 flex items-center justify-center opacity-0 group-hover:opacity-100">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      {project.link && (
                        <Link href={project.link} className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center hover:bg-[#0078B7] hover:text-white transition-all">
